        ...
        func.categories.forEach(cat => {
          cat.controls.forEach(ctrl => {
            flattenedData.push({
              ...
              // Control fields (aliased as subcategory for frontend compatibility)
              subcategory_id: ctrl.control_code,
              subcategory_name: ctrl.control_name,
              subcategory_description: ctrl.description,
              subcategory_guidance: ctrl.guidance,
              importance: ctrl.importance,
              control_id: ctrl.id
            });
          });
